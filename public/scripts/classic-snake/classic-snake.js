...
let hardMode = 0;
const audio = {
  eat: new Audio("../resources/classic-snake/sounds/eat.wav"),
  hit: new Audio("../resources/classic-snake/sounds/hit.wav"),
  lost: new Audio("../resources/classic-snake/sounds/lost.wav"),
  enabled: true,
};
