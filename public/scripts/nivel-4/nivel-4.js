...
function toggleHelpDialog() {
    ...
    if (dialogLong.style.display === 'block') {
        ...
        dialogLong.innerHTML =             
            "**********************************************************************************<br>" +
            "Nivel 4 - Condiciones:<br>" +
            "•  Orilla izquierda: 2 Lobos, 2 Cabras, 2 Coles<br>" +
            "•	Orilla derecha: Cabra<br>" +
...
function autoActivateDialog(hideAfterSeconds) {
    dialogDisplayedOneTime = getFromLocalStorage('dialogDisplayedOneTime-n-4', false);
    ...
    saveToLocalStorage('dialogDisplayedOneTime-n-4', true);
}
